...
<div class="py-24 bg-black text-white" id="process">
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-20 max-w-3xl mx-auto">
            <p class="text-sm uppercase tracking-widest text-neutral-400">Simple Process</p>
            <h2 class="text-5xl md:text-6xl font-medium mt-3">How It Works?</h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16 lg:gap-y-0">
            ...
            <div class="text-center flex flex-col items-center">
                <div class="relative w-full flex items-center justify-center" style="height: 200px;">
                    ...
                    <div class="absolute -bottom-8 w-20 h-20 bg-white text-black flex items-center justify-center"><span class="text-4xl font-bold">1</span></div>
                </div>
                <div class="mt-16">
            ...
            <div class="text-center flex flex-col items-center">
                <div class="relative w-full flex items-center justify-center" style="height: 200px;">
                    ...
                    <div class="absolute -bottom-8 w-20 h-20 bg-white text-black flex items-center justify-center"><span class="text-4xl font-bold">2</span></div>
                </div>
                <div class="mt-16">
            ...
            <div class="text-center flex flex-col items-center">
                <div class="relative w-full flex items-center justify-center" style="height: 200px;">
                    ...
                    <div class="absolute -bottom-8 w-20 h-20 bg-white text-black flex items-center justify-center"><span class="text-4xl font-bold">3</span></div>
                </div>
                <div class="mt-16">
                    <h3 class="text-xl font-semibold">Browse & Select</h3>
            ...
            <div class="text-center flex flex-col items-center">
                <div class="relative w-full flex items-center justify-center" style="height: 200px;">
                    ...
                    <div class="absolute -bottom-8 w-20 h-20 bg-white text-black flex items-center justify-center"><span class="text-4xl font-bold">4</span></div>
                </div>
                <div class="mt-16">
