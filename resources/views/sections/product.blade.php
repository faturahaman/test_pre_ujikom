<div class="py-16 md:py-24 bg-black text-white" id="product">
    <div class="container mx-auto px-4 sm:px-6">
        ...
        <div class="text-center mt-16 md:mt-20">
            <a href="#" class="inline-block border-2 border-white px-8 py-3 text-sm font-semibold uppercase tracking-wider hover:bg-white hover:text-black transition-colors">
                VIEW ALL PRODUCTS
            </a>
        </div>
